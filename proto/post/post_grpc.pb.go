...
type BorrowingPostServiceClient interface {
	...
	GetBorrowingPostDetail(ctx context.Context, in *GetBorrowingPostDetailRequest, opts ...grpc.CallOption) (*GetBorrowingPostDetailResponse, error)
}
...
func (c *borrowingPostServiceClient) GetBorrowingPostDetail(ctx context.Context, in *GetBorrowingPostDetailRequest, opts ...grpc.CallOption) (*GetBorrowingPostDetailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBorrowingPostDetailResponse)
...
type BorrowingPostServiceServer interface {
	...
	GetBorrowingPostDetail(context.Context, *GetBorrowingPostDetailRequest) (*GetBorrowingPostDetailResponse, error)
...
func (UnimplementedBorrowingPostServiceServer) GetBorrowingPostDetail(context.Context, *GetBorrowingPostDetailRequest) (*GetBorrowingPostDetailResponse, error) {
